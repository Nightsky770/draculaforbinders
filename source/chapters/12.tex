...
\begin{mail}{17 September.}{My dearest Lucy,— }
...
\closeletter[Believe me, dear Sir,\\Yours faithfully,]{Patrick Hennessey.}
\end{mail}
...
\closeletter[Your loving]{Mina Harker.}
\end{mail}

\section{Dr Seward's Diary.}

\begin{diary}{20 September.}
Only resolution and habit can let me make an entry to-night. I am too miserable, too low-spirited, too sick of the world and all in it, including life itself, that I would not care if I heard this moment the flapping of the wings of the angel of death. And he has been flapping those grim wings to some purpose of late—Lucy's mother and Arthur's father, and now\ellipsispunct{.} Let me get on with my work.
